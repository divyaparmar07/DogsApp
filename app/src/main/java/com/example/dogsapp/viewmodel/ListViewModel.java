...
public class ListViewModel extends AndroidViewModel {
    ...
    private final SharedPreferencesHelper preHelper = SharedPreferencesHelper.getInstance(getApplication());
    ...
    public void refresh() {
        checkCacheDuration();
        long updateTime = preHelper.getUpdateTime();
    ...
    private void checkCacheDuration() {
        String cachePreference = preHelper.getCacheDuration();
    ...
    private class InsertDogsTask extends AsyncTask<List<DogBreed>, Void, List<DogBreed>> {
        ...
        protected void onPostExecute(List<DogBreed> dogBreeds) {
            ...
            preHelper.saveUpdateTime(System.nanoTime());
        }
    }
